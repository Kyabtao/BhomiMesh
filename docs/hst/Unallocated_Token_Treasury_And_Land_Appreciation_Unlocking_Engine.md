...
**Tags:** Treasury Engine · Unlock Schedule


## Sections

1. 1. The Core Innovation: Fixed Minting with Dynamic Unallocated Lockup
2. 2. Formulas & Token Flow Mechanics
3. 3. Landowner Tokenization & Unallocated Vault Lockup Table
4. 🚀 4. How Land Appreciation Unlocks Tokens Over Time (Development Dividend)
